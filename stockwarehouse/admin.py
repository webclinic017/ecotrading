...
class TransactionAdmin(admin.ModelAdmin):
    ...
    list_display = ['account','stock','position','price','qty','net_total_value','created_at','user_created','transaction_fee','tax']
...
class PortfolioAdmin(admin.ModelAdmin):
    model= Portfolio
    list_display = ['account','stock','market_price','avg_price','on_hold','receiving','profit','percent_profit']
    search_fields = ['stock',]
...
class CashTransferAdmin(admin.ModelAdmin):
    model= CashTransfer
    list_display = ['account','created_at','amount','user_created','user_modified']
